					...
					<div class="card-body">
						<div class="stats-list">
							<div class="stats-info">
								...
								<p>Annual Leave <strong>{{$leave_bal->annual}} <small>/ 21 days</small></strong></p>
								<div class="progress">
							...
							<div class="stats-info">
								<p>Sick offs <strong>{{$leave_bal->sick}}<small>/ 10</small></strong></p>
								<div class="progress">
							...
							<div class="stats-info">
								<p>Compassionate <strong>{{$leave_bal->compassionate}} <small>/ 5</small></strong></p>
								<div class="progress">
							...
							<div class="stats-info">
								<p>Paternity Leave <strong>{{$leave_bal->paternity}} <small>/ 14</small></strong></p>
								<div class="progress">
							...
							<div class="stats-info">
								<p>Maternity Leave <strong>{{$leave_bal->maternity}} <small>/ 90</small></strong></p>
								<div class="progress">
			...
			<div class="col-md-12 col-lg-6 col-xl-4 d-flex">
				<div class="card flex-fill border-success">
					...
					<div class="card-body">
						...
						<h5 class=""> Day off<span class="badge bg-inverse-danger ml-2">3</span></h5	>
